...
import { ArrowRight, Sparkles, Zap, Users, Award, BookOpen, Globe } from "lucide-react";
  ...
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden bg-gradient-hero">
      <div className="absolute inset-0">
        <img src={heroImage} alt="DigiUniversity campus" className="w-full h-full object-cover opacity-15" />
        <div className="absolute inset-0 bg-gradient-to-br from-primary/80 via-primary-glow/60 to-accent/30" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <div className="max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-accent/20 backdrop-blur-sm border border-accent/30 rounded-full px-4 py-2 mb-6 animate-fade-in">
            ...
            <span className="text-xs sm:text-sm font-medium text-primary-foreground">Kenya's Premier Digital University</span>
          </div>
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-primary-foreground/95 mb-4 max-w-3xl mx-auto animate-slide-up font-medium leading-relaxed min-h-[2em]">
            <span className="transition-all duration-500 ease-in-out">{typewriterTexts[currentText]}</span>
          </p>
          ...
          <p className="text-sm sm:text-base md:text-lg text-primary-foreground/80 mb-10 max-w-2xl mx-auto animate-slide-up font-medium">
            World-Class Research • Industry Partnerships • Future-Ready Graduates
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-12 animate-slide-up">
            <div className="flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
              ...
              <span className="text-xs sm:text-sm font-medium text-primary-foreground">Smart Campus</span>
            </div>
            <div className="flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
              <Users className="w-4 h-4 text-accent" />
              <span className="text-xs sm:text-sm font-medium text-primary-foreground">Expert Faculty</span>
            </div>
            <div className="flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-2">
              <Sparkles className="w-4 h-4 text-accent" />
              <span className="text-xs sm:text-sm font-medium text-primary-foreground">Global Network</span>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 animate-slide-up max-w-4xl mx-auto px-4">
            <Button size="lg" className="bg-accent hover:bg-accent-light text-accent-foreground font-bold px-6 sm:px-10 py-4 sm:py-6 shadow-accent text-base sm:text-lg rounded-full transform hover:scale-105 transition-all duration-300 border-2 border-accent w-full sm:w-auto group" asChild>
              <Link to="/admissions">
            ...
            <Button variant="outline" size="lg" className="border-2 border-accent/80 bg-accent/10 backdrop-blur-sm text-accent hover:bg-accent hover:text-accent-foreground px-6 sm:px-10 py-4 sm:py-6 font-bold text-base sm:text-lg rounded-full transform hover:scale-105 transition-all duration-300 w-full sm:w-auto" asChild>
              <Link to="/fees">Pay Tuition</Link>
            </Button>
            <Button variant="ghost" size="lg" className="bg-primary-foreground/10 backdrop-blur-sm text-primary-foreground hover:bg-primary-foreground hover:text-primary px-6 sm:px-10 py-4 sm:py-6 font-bold text-base sm:text-lg rounded-full transform hover:scale-105 transition-all duration-300 border-2 border-primary-foreground/40 w-full sm:w-auto" asChild>
              <Link to="/auth">Student Portal</Link>
            </Button>
          </div>
        </div>
      </div>
